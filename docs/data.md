...
Файл `solution.csv` содержит эталонные значения для оценки решения. Он находится в приватной директории и недоступен участникам до завершения соревнования.
